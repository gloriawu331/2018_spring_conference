...
date <- "3/1/2018"
vendor <- "Pizza Capri"
title <- "Winter 2018 MACSS Student Conference"
file_title <- "Paper Title"
short_title_n = 2
speaker <- "Student Speakers TBD"
department <- "An Opportunity for Second Year MACSS Students to Present Their Thesis Research"
university <- "Stay Tuned for Further Details"
